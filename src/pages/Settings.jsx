        ...
        <div className="min-h-screen bg-slate-50 p-8">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
                    ...
                    {message && (
                        <div className={`p-4 rounded-xl mb-6 flex items-center gap-2 border ${message.includes('Error') ? 'bg-red-50 text-red-700 border-red-100' : 'bg-green-50 text-green-700 border-green-100'}`}>
                    ...
                    <form onSubmit={handleSave} className="space-y-6">
                        ...
                        <div className="border border-slate-200 rounded-xl overflow-hidden">
                            ...
                            >
                                <span className="font-semibold text-slate-700">Advanced: System Prompt</span>
                                <span className="text-slate-500 text-sm">{showPrompt ? 'Hide' : 'Show'}</span>
                            </button>
...
Analyze the text and return ONLY the raw JSON.`);
                                            ...
                                            className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-medium rounded-lg transition-colors border border-slate-200 whitespace-nowrap"
                                        >
                        ...
                        <div className="pt-4 border-t border-slate-100">
                            <button
                                type="submit"
                                disabled={isSaving}
                                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-all shadow-lg shadow-blue-200 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                {isSaving ? (
                                    <>
